...
table(class)
cat("Thus, we can see that: FOR 3 CLUSTER SYSTEM
1. Out of 151 actual Adelie species, 146 were correctly identified and rest 5 were wrongly identified.
2. Out of 68 actual Chinstrap species, 59 were correctly identified and rest 9 were wrongly identified.
3. Out of 123 actual Gentoo species, 122 were correctly identified and rest 1 is wrongly identified.")
